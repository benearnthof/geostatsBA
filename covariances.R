...
require(rstan)
require(StanHeaders)
brm_custom_1d <- rstan::stan_model("onedimGP.stan", allow_undefined = TRUE,
                            includes = paste0('\n#include "', file.path(getwd(),'sqexpcovariance.hpp'), '"\n'))
...
# lets try interfacing with the stan math library and see from there
# https://stackoverflow.com/questions/48574824/optimizing-gaussian-process-in-stan-rstan
